...
mkDerivation {
  ...
  libraryHaskellDepends = [
    aeson async base bytestring chronos containers envparse esqueleto
    extra hspec http-client http-client-tls http-types katip persistent
    persistent-postgresql persistent-template retry safe-money stm
